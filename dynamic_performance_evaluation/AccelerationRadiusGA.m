...
IntCon = [5,6,7,8,9,10];
options = optimoptions('ga','Generations',400,'PopulationSize',100,'Display','iter','MutationFcn',{'mutationadaptfeasible'},'StallGenLimit',50,'UseParallel', true, 'UseVectorized', false);
tic

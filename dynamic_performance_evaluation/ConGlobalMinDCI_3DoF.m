function [c,ceq] = ConGlobalMinDCI_3DoF(x,xi_ai,xi_pi,gst0,gsli0,M0b_CoM)
% Constraint function for GlobalMinDCI.m
...
% for ta1=-1.5708:step_a1:1.5708
    ...
    %         exp_ai(:,:,6) = twistexp(xi_ai(:,6), q(6));
            ...
            % Jacobians: J,Jdot
            [~,Jb,~] = CalculateMetamorphicJacobians_3DoF(q',xi_ai,tpi,xi_pi,Pi,gst0);

function DCI = MinDCI(x,xi_ai,xi_pi,gst0,gsli0,M0b_CoM)
...
[Jbsli,~,Jbsli_POE,~] = CalculateCoMBodyJacobians_6DoF(q,xi_ai,Pi,gsli0);
...
DCI = CalculateDynamicConditioningIndex(Mb,6);

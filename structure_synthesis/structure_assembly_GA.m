...
switch structure(2,:) 
    case 'xSB10'
        ...
        P1 = [0.05 0.05 0]; % normally ga gives them
...
switch structure(3,:)
    ...
    case 'SB110'
        ...
        n = 3; % Structural Block number
        R2 = [1 0 1]; % normally ga gives them
        P2 = [0.05 0 0]; % normally ga gives them
        [S3] = Build_SB110_forGA(S2,s3,R2,P2,n,point2figure,[t0; t110],x1);
        a3 = 4; % column of second active joint in final Js
    otherwise
        warning('Unexpected structural block entered!')
end
